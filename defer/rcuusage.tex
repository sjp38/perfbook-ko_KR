...
\QuickQuizAnswer{
	...
	이 말은 자미막 원소가 해제된 뒤에 시작된 어떤 RCU grace period 도---그
	슬랩은 그 grace period 가 끝난 후에 시스템에 반환될 것입니다.
	\iffalse
...
따라서, type-safety 기반의 락을 사용하지 않은 알고리즘들이 매우 희소한 어려운
상황에서는 극단적으로 도움이 될 수 있지만, 가능하다면 그대신 존재 보장을
사용해야 합니다.
더 간단한게 거의 항상 더 낫습니다!
\iffalse
