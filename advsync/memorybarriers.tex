...
Table~\ref{tab:advsync:A Variable With More Simultaneous Values} 를 생각해
봅시다.
테이블의 첫번째 행은 시간 기반의 틱들로 측정된 시간을 보이고, 그런 각각의 틱은
...
증가합니다.
표의 뒤의 15개의 행들은 연관된 CPU 에 의해서 각 시점마다 가장 최근에 관측된
값을 기록하는데, 값에의 변경은 이탤릭체와 괄호로 표시되어 있습니다.
