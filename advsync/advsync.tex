...
이론이 우선해야 한다고 생각하는 분은 운영체제에 대해
``Theory follows practice''~\cite{Denning:2015:POF:2830903.2830904} 라고 한,
비길데 없이 훌륭한 Peter Denning 또는 공학 전체에 대해
...
study!''~\cite{RichardMorris2007TonyHoareInterview} 라고 한 탁월한 Tony Hoare
를 참고하시기 바랍니다.
그러나, 적절한 이론이 만들어지면,\footnote{
	이론의 첫번째 \emph{적절한} 몸체는 종종 첫번째 \emph{제안된} 이론의
	몸체와 별개임도 유의하시기 바랍니다.}
그걸 사용하는게 현명할 겁니다.
