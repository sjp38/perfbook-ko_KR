...
Listing~\ref{lst:app:whymb:Memory Barrier Example 1} 는 각각 CPU~0, 1, 2 에서
...
Listing~\ref{lst:app:whymb:Memory Barrier Example 2} 는 각각 CPU~0, 1, 2 에서
동시에 수행되는 코드를 보이고 있습니다.
``a'', ``b'', ``c'' 는 처음엔 0 값을 갖습니다.
\iffalse
...
\QuickQuiz{}
	Listing~\ref{lst:app:whymb:Memory Barrier Example 3} 에서 CPU~1 과 2 의
...
\QuickQuiz{}
	Listing~\ref{lst:app:whymb:Memory Barrier Example 3} 의 예에서 CPU~2 가
