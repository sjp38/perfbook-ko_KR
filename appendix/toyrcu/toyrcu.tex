...
\QuickQuizAnswer{
	...
	\fi
	\begin{enumerate}
	\item	Figure~\ref{fig:app:toyrcu:RCU Read-Side Using Global Reference-Count Pair}
		\co{rcu_read_lock()} 의 line~8 에서 \co{rcu_idx} 를 가져오고 그
		값이 0임을 확인합니다.
	\item	Figure~\ref{fig:app:toyrcu:RCU Update Using Global Reference-Count Pair}
...
보입니다.
이 구현은
Figure~\ref{fig:app:toyrcu:RCU Read-Side Using Global Reference-Count Pair} 에서
보인 구현과 상당히 비슷한데, 차이점은 \co{rcu_refcnt} 가 (
Figure~\ref{fig:app:toyrcu:RCU Per-Thread Reference-Count Pair Data} 에 보인 것과
...
Figure~\ref{fig:app:toyrcu:RCU Update Using Global Reference-Count Pair} 에 보인
...
보입니다.
Figure~\ref{fig:app:toyrcu:RCU Read-Side Using Per-Thread Reference-Count Pair} 로
...
함수를 보입니다.
이것들은
Figure~\ref{fig:app:toyrcu:RCU Update Using Per-Thread Reference-Count Pair} 에 있던
것들과 비슷합니다.
...
는 Figure~\ref{fig:app:toyrcu:Data for Free-Running Counter Using RCU} 에 보여진
...
\QuickQuiz{}
	...
	말하기에 충분하다면
	Figure~\ref{fig:app:toyrcu:Free-Running Counter Using RCU} 의 line~10 과 11
...
\QuickQuiz{}
	...
	Figure~\ref{fig:app:toyrcu:Free-Running Counter Using RCU} 에 보인 구현에
	적용될 수도 있지 않을까요?
	\iffalse
...
에 값을 저장하기 전에 Figure~\ref{fig:app:toyrcu:Free-Running Counter Using RCU} 의
...
\QuickQuiz{}
	Figure~\ref{fig:app:toyrcu:Free-Running Counter Using RCU} 의 line~3-4 에서
...
이 중첩 가능성은
Figure~\ref{fig:app:toyrcu:Data for Nestable RCU Using a Free-Running Counter} 에
...
\QuickQuiz{}
	Figure~\ref{fig:app:toyrcu:Nestable RCU Using a Free-Running Counter} 에
...
\QuickQuiz{}
	다시, Figure~\ref{fig:app:toyrcu:Nestable RCU Using a Free-Running Counter}
...
Figure~\ref{fig:app:toyrcu:Data for Quiescent-State-Based RCU} 에 보인 데이터와 함께
...
\QuickQuiz{}
	...
	Figure~\ref{fig:app:toyrcu:Quiescent-State-Based RCU Read Side} 와
	\ref{fig:app:toyrcu:RCU Update Side Using Quiescent States} 에 보여진 RCU
