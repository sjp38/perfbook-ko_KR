...
\newcommand{\creflastconjunction}{, 그리고~}
...
\newcommand{\clnrefp}[2]{%
  ...
  \else\ifnum\value{lblcount}=2 {#2}~%
  \renewcommand*{\do}[1]{%
    \addtocounter{lblcount}{-1}%
    \ifnum\value{lblcount}=0 { }와~\else\nextitem\fi\lnref{##1}}% How to process each label
  \else {#2}s~%
  \renewcommand*{\do}[1]{%
    \addtocounter{lblcount}{-1}%
    \ifnum\value{lblcount}=0 , 그리고~\else\nextitem\fi\lnref{##1}}% How to process each label
  \fi%
...
\newcommand{\clnref}[1]{\clnrefp{#1}{라인}}
\newcommand{\Clnref}[1]{\clnrefp{#1}{라인}}
\newcommand{\clnrefrange}[2]{라인~\lnref{#1}\==\lnref{#2}}
\newcommand{\Clnrefrange}[2]{라인~\lnref{#1}\==\lnref{#2}}
\newcommand{\clnrefthro}[2]{라인~\lnref{#1} 부터~\lnref{#2}}
\newcommand{\Clnrefthro}[2]{라인~\lnref{#1} 부터~\lnref{#2}}
\newcommand{\pararef}[1]{\pageref{#1} 페이지의 ``\nameref{#1}'' 문단}
\newcommand{\Pararef}[1]{\pageref{#1} 페이지의 ``\nameref{#1}'' 문단}
