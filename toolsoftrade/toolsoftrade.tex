...
Section~\ref{sec:toolsoftrade:Alternatives to POSIX Operations}
presents the analogous operations within other environments, and finally,
Section~\ref{sec:toolsoftrade:The Right Tool for the Job: How to Choose?}
...
\co{ACCESS_ONCE()} 함수는 컴파일러가 루프의 매 수행마다 \co{goflag} 를 실제로
...
에서처럼 \co{ACCESS_ONCE()} 함수가 사용될 수 있을 겁니다.
...
통념적인 값 증가 방법 (``counter++'') 과 비교해 보는 것이 도움이 될 것입니다.
\iffalse
