...
of a claim that his or her code had been automatically verified.
One way of dealing with such skepticism is to provide bug-injected
versions of the code in question.
If the formal-verification tool finds all the bugs, our hacker might
have more confidence in the tool's capabilities.
