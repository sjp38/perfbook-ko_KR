...
\co{rcu_irq_exit()} 의 \clnref{dynticks_nesting} 은 \co{dynticks_nesting} 의
값을 감소시키고, 그 결과가 0이 아니라면 \clnref{ret2} 에서 조용히 리턴합니다.
...
\Clnref{rec_nsap,rec_snapn} 은 \co{rcu_implicit_dynticks_qs()} 의 다음 호출을
