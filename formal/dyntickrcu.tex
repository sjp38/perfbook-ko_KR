...
\QuickQuiz{}
	하지만, 만약 NMI 핸들러가 irq 핸들러가 완료되기 전에 동작하기 시작하면,
	그리고 그 NMI 핸들러가 두번째 irq 핸들러가 시작될 때까지 돌아가면 어떤
	일이 발생할까요?
	\iffalse

	But what happens if an NMI handler starts running before
	% TODO: Apply to Korean trans
...
\QuickQuizAnswer{
	...
	첫번째 irq 핸들러는 NMI 핸들러가 리턴하기 전까지는 완료될 수 없습니다.
