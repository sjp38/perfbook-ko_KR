...
지시어이며, \co{V} 는 그 값입니다.
예를 들어, 프로세스~0 의 레지스터 r3 는 초기에 값 2를 가지고 있습니다.
...
의 r3 레지스터가 두 쓰레드가 모두 수행을 끝낸 후 모두 0이 될 수 있는지에 우리가
관심있음을 보입니다.
P0 와 P1 이 각자의 r3 레지스터에서 둘 다 0을 보게 된다면 비참한 실패를 유발할
수 있는 많은 사용 경우가 있기 때문에 중요합니다.
